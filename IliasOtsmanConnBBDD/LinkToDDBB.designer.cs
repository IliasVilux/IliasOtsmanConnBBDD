...
namespace IliasOtsmanConnBBDD
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="IliasEmployees")]
	public partial class LinkToDDBBDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void Deletelocations(locations instance);
		...
		public LinkToDDBBDataContext() : 
				base(global::IliasOtsmanConnBBDD.Properties.Settings.Default.IliasEmployeesConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public LinkToDDBBDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public LinkToDDBBDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public LinkToDDBBDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public LinkToDDBBDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void Ondepartment_idChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="jobs_employees", Storage="_jobs", ThisKey="job_id", OtherKey="job_id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public jobs jobs
		{
			get
			{
    ...
    partial void Onmax_salaryChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="jobs_employees", Storage="_employees", ThisKey="job_id", OtherKey="job_id")]
		public EntitySet<employees> employees
		{
			get
			{
